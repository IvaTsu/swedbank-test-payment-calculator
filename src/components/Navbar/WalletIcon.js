...
export default ({ width, height, fill }) => (
    <svg width={ width } height={ height } viewBox="0 0 20 19" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <title>everyday_banking</title>
        <desc>Created with Sketch.</desc>
        <defs />
        <g id="Sprite" stroke="none" fill="none">
            <g id="sprite" transform="translate(-370.000000, -190.000000)" fill={ fill }>
                <g id="Menu-items" transform="translate(340.000000, 189.000000)">
                    <g id="everyday_banking" transform="translate(30.000000, 1.000000)">
