...
export default ({ width, height, fill }) => (
    <svg width={ width } height={ height } viewBox="0 0 20 18" version="1.1" xmlns="http://www.w3.org/2000/svg">
        <title>home</title>
        <desc>Created with Sketch.</desc>
        <defs/>
        <g id="Sprite" stroke="none" fill="none">
            <g id="sprite" transform="translate(-340.000000, -191.000000)" fill={ fill }>
